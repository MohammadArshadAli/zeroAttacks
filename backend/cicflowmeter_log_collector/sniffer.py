...
def create_sniffer(
    input_file, input_interface, output_mode, output_file, url_model=None, generate_false_attacks=False
):
    assert (input_file is None) ^ (input_interface is None)

    NewFlowSession = generate_session_class(output_mode, output_file, url_model,generate_false_attacks)
...
def main_import(input_interface,output=None,generate_false_attacks=False,url_model=True,output_mode="flow",input_file=None):
    sniffer = create_sniffer(
        input_file,
        input_interface,
        output_mode,
